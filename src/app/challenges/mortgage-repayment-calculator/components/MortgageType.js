  ...
  return (
    <div className="flex flex-col gap-2 md:gap-4  ">
      ...
      <div className="flex flex-col gap-2 md:gap-4 relative">
        <div
          className={`w-full ring-1 h-10 rounded-md flex items-center px-4 gap-4 hover:ring-mrc-Lime focus-within:ring-mrc-Lime hover:ring-opacity-70 ${
            type === "repayment"
        ...
        {error && (
          <span className="text-xs absolute -bottom-5 text-mrc-red">
            {error}
          </span>
        )}
      </div>
