...
const Page = () => {
  return (
    <div className="min-h-screen bg-hlp-Violet bg-[url('/huddle-landing-page/bg-mobile.svg')] md:bg-[url('/huddle-landing-page/bg-desktop.svg')] bg-repeat-x md:bg-no-repeat bg-cover md:bg-contain flex justify-center py-12">
      <main className="flex justify-center items-center flex-col gap-12 md:gap-20 px-8 lg:px-24">
        ...
        <div className="flex gap-12 flex-col md:flex-row w-full h-full">
