...
const page = () => {
  return (
    <main className="font-barlow bg-tgs-Lightgray p-2 sm:p-4 md:p-6 lg:p-8 xl:p-12">
      <div>
        <section className="flex flex-col justify-center gap-8 m-4 lg:grid grid-cols-4 lg:mx-auto grid-rows-2 max-w-[1200px]">
          <article className="bg-tgs-Moderateviolet text-tgs-White rounded-md p-8 flex flex-col gap-6 col-span-2 relative">
            <Image
              src="/testimonials-grid-section/bg-pattern-quotation.svg"
              alt="bg-pattern-quotation"
              className="absolute -top-[1px] right-8 opacity-40"
              width={100}
              height={100}
            />
            <div className="flex justify-start items-center gap-4">
              <div className="">
                <Image
                  ...
                  width="28"
                  height="28"
                  className="rounded-full ring-1 ring-tgs-White object-cover"
                  alt="image-daniel"
                />
              </div>
              <div className="">
                <p className="text-sm font-medium">Daniel Clifford</p>
                <p className="text-sm text-tgs-Lightgray">Verified Graduate</p>
              </div>
            </div>
            <div className="grid gap-6">
              ...
              <h2 className="text-sm text-tgs-Lightgray">
          ...
          <article className="bg-tgs-Verydarkgrayishblue text-tgs-White rounded-md p-8 flex flex-col gap-6">
            <div className="flex justify-start items-center gap-4">
              <div className="">
                <Image
              ...
              <div className="">
                <p className="text-sm font-medium">Jonathan Walters</p>
                <p className="text-sm text-tgs-Lightgray">Verified Graduate</p>
              </div>
            </div>
            <div className="grid gap-6">
          ...
          <article className="bg-tgs-White rounded-md p-8 flex flex-col gap-6 row-start-2">
            <div className="flex justify-start items-center gap-4">
              <div className="">
                <Image
              ...
              <div className="">
                <p className="text-sm font-medium">Jeanette Harmon</p>
                <p className="text-sm text-tgs-Verydarkgrayishblue">
                  Verified Graduate
                </p>
              </div>
            </div>
            <div className="grid gap-6">
              ...
              <h2 className="text-sm text-tgs-Verydarkgrayishblue">
          ...
          <article className="bg-tgs-Verydarkblackishblue text-tgs-White rounded-md p-8 flex flex-col gap-6 col-span-2">
            <div className="flex justify-start items-center gap-4">
              <div className="">
                <Image
              ...
              <div className="">
                <p className="text-sm font-medium">Patrick Abrams</p>
                <p className="text-sm text-tgs-Lightgray">Verified Graduate</p>
              </div>
            </div>
            <div className="grid gap-6">
          ...
          <article className="bg-tgs-White text-tgs-Verydarkgrayishblue rounded-md p-8 flex flex-col gap-6 row-start-1 col-start-4 row-end-3">
            <div className="flex justify-start items-center gap-4">
              <div className="">
                <Image
              ...
              <div className="">
                <p className="text-sm font-medium">Kira Whittle</p>
                <p className="text-sm text-tgs-Verydarkgrayishblue">
                  Verified Graduate
                </p>
              </div>
